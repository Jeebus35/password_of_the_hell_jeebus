...
user = User.create!(first_name: 'anonymous', last_name: 'anonymous', description: Faker::Quote.yoda, email: Faker::Internet.email, age: Faker::Number.number(digits: 2), city: City.all.sample, password: Faker::Name.first_name)
10.times do
  user = User.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: Faker::Quote.yoda, email: Faker::Internet.email, age: Faker::Number.number(digits: 2), city: City.all.sample, password: Faker::Name.first_name)
end
